...
I'm a system administrator and network engineer based in Tashkent, Uzbekistan. I focus on reliable infrastructure, clear networks, Linux, DevOps, and practical automation.

- **Infrastructure:** MikroTik, UniFi, VLAN, VPN, CCTV, Yeastar, iiko POS
- **Systems & DevOps:** Linux, Windows, Docker, Git, GitHub Actions
- **Automation & AI:** Python, Codex, OpenClaw, LiteLLM, AI agents

## Building

### [SIGAMIZ](https://github.com/willlrock/sigamiz)

A free roommate map for students in Tashkent — no brokers and no commission.

## Current focus

- Keeping production infrastructure reliable
- Deepening my DevOps skills
- Automating repetitive work
- Learning German

<p align="center">
  <sub>Reliable systems · Clear networks · Useful software</sub>
</p>
